...
class Address extends \Faker\Provider\es_ES\Address
{
    ...
    protected static $streetPrefix = array(
        'Calle', 'Avenida', 'Av.', 'Cl.', 'Carrera'
    );
    protected static $streetSuffix = array('Norte', 'Este', ' Sur', ' Oeste');
    protected static $postcode = array('####');
    protected static $state = array(
        'Bogota DC', 'Amazonas', 'Antioquia', 'Arauca', 'Atlántico', 'Bolívar', 'Boyacá', 'Caldas', 'Caquetá', 'Casanare', 'Cauca',
    ...
    protected static $community = array(
        ...
        'Icononzo', 'Mariquita', 'Melgar', 'Murillo', 'Natagaima', 'Ocaña', 'Palocabildo', 'Piedras', 'Planadas', 'Prado',
